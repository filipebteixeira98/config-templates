...
export PATH="$PATH:/home/d4rks0ul/.cache/lm-studio/bin"
# set nvm binary as an alias to path environment variable
export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion
# set android studio configuration
...
# pnpm
export PNPM_HOME="/home/d4rks0ul/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
